...
use App\Http\Requests\Back\Dashboard\UpdateArticleRequest as DashboardUpdateArticleRequest;
...
class StoreArticleController extends Controller
{
    public function getData ()
    {
        ...
        // Nombre total de vues de tous les articles
    ...
    public function update(DashboardUpdateArticleRequest $request, Article $article) 
    {
        try {
            DB::beginTransaction();
            $data = $request->validated();
