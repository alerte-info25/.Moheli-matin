...
sortSelect.addEventListener('change', function() {
    ...
    switch(sortMethod) {
        case 'newest':
            message = 'Articles triés par date (plus récent)';
            break;
        case 'popular':
            message = 'Articles triés par popularité';
            break;
        case 'commented':
            message = 'Articles triés par nombre de commentaires';
            break;
    }
...
newsletterForm.addEventListener('submit', function(e) {
    ...
    showToast('Inscription réussie', `Vous recevrez nos actualités à ${email}`, 'success');
    this.reset();
});
...
document.querySelectorAll('.article-card').forEach(article => {
    article.addEventListener('click', function() {
        ...
        showToast('Article sélectionné', `Ouverture de : ${title}`, 'info');
    });
});
...
console.log('MOHELI MATIN - Page Politique chargée avec succès');