...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.btn-play').forEach(button => {
        button.addEventListener('click', function () {
            ...
            // Utiliser textContent pour le titre (pas de HTML)
            modalAudioTitle.textContent = title;
            playerTitle.textContent = title;
            playerHost.textContent = host;
            modalInfoTitle.textContent = title;
            
            // CORRECTION PRINCIPALE : Utiliser innerHTML pour afficher le HTML formaté
            modalInfoDescription.innerHTML = description;
            ...
            if (image && image !== '') {
                audioCover.innerHTML = `<img src="${image}" alt="Cover" style="width:100%; height:100%; object-fit:cover; border-radius: 10px">`;
            } else {
