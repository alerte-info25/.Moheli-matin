<link rel="stylesheet" href="{{ asset("css/back/headerAjust.css") }}">
...
<nav class="sidebar-nav">
    ...
    <div class="nav-section">
        <div class="nav-section-title">Monétisation</div>
        <div class="nav-item">
            <a href="{{ route("dashboard.publicites.create") }}" class="nav-link {{ request()->routeIs("dashboard.publicites.create") ? "active" : "" }}">
                <i class="fas fa-envelope-open-text"></i>
                <span>Nouvel publicité</span>
            </a>
        </div>
        <div class="nav-item">
            <a href="{{ route("dashboard.publicites.index") }}" class="nav-link {{ request()->routeIs("dashboard.publicites.index") ? "active" : "" }}">
                <i class="fa-solid fa-list"></i>
