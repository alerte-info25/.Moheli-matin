...
<head>
    ...
    <title>Ajouter Employé - MOHELI MATIN Admin</title>
        ...
        <div class="main-content">
            ...
            <div class="content-area">
                ...
                <div class="page-header">
                    ...
                    <p class="page-description">Enregistrez un nouveau membre de l'équipe MOHELI MATIN</p>
                </div>
                        ...
                        <div class="success-modal show" id="successModal">
                            <div class="success-content">
                                ...
                                <p class="success-message">
                                    <strong>{{ session('alert')['nom'] ?? '' }}</strong> a été ajouté à la base de données MOHELI MATIN.<br>
                        ...
                        <div class="form-card">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" placeholder="exemple@MOHELI MATIN.ci" value="{{ old("email") }}" required>
                                </div>
                            </div>
